...
# 保存图表到文件
plt.savefig("resnet101_training_plot.png")  # 保存为 PNG 格式
print("训练图表已保存为 'resnet101_training_plot.png'")

# 保存最终模型
torch.save(model.state_dict(), "./resnet101_cifar100_trained.pth")
print("ResNet101 模型训练完成并保存。")